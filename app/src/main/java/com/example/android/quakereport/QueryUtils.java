...
public final class QueryUtils {
    ...
    public static List<Earthquake> fetchEarthquakeData(String requestURL) {
        ...
        //Extract relevant fields from the JSON response and create a list of {@link Earthquake} objects
    ...
    public static List<Earthquake> extractFeatureFromJSON(String earthquakeJson) {
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                // For given earthquake, extract the JSONObject associated with the
                // key called "properties", which represents a list of all properties
                // for that earthquake
                JSONObject property = currentEarthquake.getJSONObject("properties");
                //Extract value for the key called "mag", "place", "time" and "url"
                ...
                // and url to the JSON response and add it to the list of earthquakes
